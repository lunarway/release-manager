...
// WithService adds the service to the get policies params
func (o *GetPoliciesParams) WithService(service string) *GetPoliciesParams {
	o.SetService(service)
	return o
}

// SetService adds the service to the get policies params
func (o *GetPoliciesParams) SetService(service string) {
	o.Service = service
}
